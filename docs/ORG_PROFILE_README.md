...
|---|---|---|
| **[Maul](https://github.com/invariant-sh/maul)** | Adversarial HTTP proxy — inject LLM faults, enforce observed budgets, produce reliability evidence | Open source (v0.1) |
